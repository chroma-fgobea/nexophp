...
<head>
    ...
    <title>Editar Sandbox - Nexo.ia Bot Sandbox</title>
...
<body>
    <div class="d-flex">
        ...
        <div class="main-content">
            <div class="header">
                <h1>Editar Sandbox: <?php echo $sandbox['name']; ?></h1>
                <div class="user-info">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="process/update_sandbox.php" method="post">
                        <input type="hidden" name="sandbox_id" value="<?php echo $sandbox_id; ?>">
                        
                        <div class="mb-3">
                            <label for="name" class="form-label">Nombre del Sandbox</label>
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($sandbox['name']); ?>" required>
                            <div class="form-text">Un nombre descriptivo para identificar este sandbox.</div>
                        </div>
                        
                        <div class="mb-3">
                            <label for="description" class="form-label">Descripción</label>
                            <textarea class="form-control" id="description" name="description" rows="3"><?php echo htmlspecialchars($sandbox['description']); ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="script_code" name="script_code" rows="5" required><?php echo htmlspecialchars($sandbox['script_code']); ?></textarea>
                            <div class="form-text">Código del script generado en SendPulse.</div>
                        </div>
                        
                        <div class="d-flex justify-content-between">
                            <a href="sandbox_detail.php?id=<?php echo $sandbox_id; ?>" class="btn btn-secondary">Cancelar</a>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        <i class="bi bi-info-circle"></i> La vista previa mostrará los cambios después de guardar.
                    </div>
